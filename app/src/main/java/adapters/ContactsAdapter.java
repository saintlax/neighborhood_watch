...
public class ContactsAdapter extends BaseAdapter {
    ...
    public ContactsAdapter(Activity act, JSONArray arraylist){
        this.context = act;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            detail.setText("");
            mStatus.setText("");
            name.setText(Html.fromHtml(jObj.getString("title")+" "+jObj.getString("first_name")+" "+jObj.getString("last_name")+" "+jObj.getString("other_names")));
            phone.setText("Phone: "+jObj.getString("phone"));
            Message msg = lastMessage(jObj.getString("id"));
            if(msg != null){
                String type = msg.type;
                switch (type){
                    case "image/png":case "image/jpeg":case "jpg":case "image/jpg":
                        detail.setText("*** PICTURE ***");
                        break;
                    default:
                        detail.setText(Html.fromHtml(msg.message));
                        break;
                }
                mStatus.setText(formatTime(msg.time));
            }

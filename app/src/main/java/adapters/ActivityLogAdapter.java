...
public class ActivityLogAdapter extends BaseAdapter {
    ...
    public ActivityLogAdapter(Activity act, JSONArray arraylist){
        this.context = act;
        postItems = arraylist;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
       ...
       // does not update the listView
         convertView= inflater.inflate(R.layout.row_for_activity_log, null);
        ...
        try {
            ...
            TextView datee = (TextView)convertView.findViewById(R.id.date);
            title.setText(Html.fromHtml(jObj.getString("activity")));
            datee.setText(jObj.getString("date"));
        } catch (JSONException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }

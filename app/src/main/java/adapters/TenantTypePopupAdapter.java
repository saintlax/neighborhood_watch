...
public class TenantTypePopupAdapter extends BaseAdapter {
    Context context;
    List<TenantType> menu_name;
    DisplayImageOptions options;
    ImageLoaderConfiguration imgconfig;
    private ImageLoadingListener animateFirstListener = new AnimateFirstDisplayListener();
    public TenantTypePopupAdapter(Context act, List<TenantType> menu_name){
        this.context = act;
    ...
    public String getItem(int position) {
        try{
            ...
            TenantType tenantType = menu_name.get(position-1);

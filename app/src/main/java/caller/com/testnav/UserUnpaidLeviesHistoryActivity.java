...
import adapters.UnpaidLeviesHistoryAdapter;
...
public class UserUnpaidLeviesHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = UserUnpaidLeviesHistoryActivity.this;
        ...
        if(user == null){
            startActivity(new Intent(UserUnpaidLeviesHistoryActivity.this,LoginActivity.class));
            finish();
            return;
        }
    ...
    private void loadSubjects(JSONArray returnedJSON){
        if(returnedJSON.length()==0){
            ...
            String message = "<b>Payment has not be recorded in this log </b>";
            textView.setText(Html.fromHtml(message));
        }else{
            ListView listview = (ListView)findViewById(R.id.listview);
            final UnpaidLeviesHistoryAdapter adapter = new UnpaidLeviesHistoryAdapter(context, returnedJSON);
    ...
    private void getHistory(User user,String member_id){
        ...
        RequestBody request_body = new MultipartBody.Builder().setType(MultipartBody.FORM)
                ...
                .build();
        serverRequests.post(request_body, "user_levies_unpaid_history.php", new GetJSONCallback() {
            @Override

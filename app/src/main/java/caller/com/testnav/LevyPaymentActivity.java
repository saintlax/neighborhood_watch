...
public class LevyPaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = LevyPaymentActivity.this;
        Intent intent = getIntent();
        Bundle bundle = intent.getExtras();
        levy_id = bundle.getString("levy_id");
        levy_amount = bundle.getString("amount");
        levy_name = bundle.getString("levy_name");
        ...
        getAllUnpaidUsers(levy_id,street_id);
    }
    ...
    private void getAllUnpaidUsers(String levy_id,String street_id){
